...
def _trajectory_history() -> pd.DataFrame:
    columns = ["canonical_project_id", "snapshot_date", "revised_cost_cr", "cumulative_expenditure_cr", "physical_progress", "planned_completion_date", "revised_completion_date", "actual_completion_date"]
