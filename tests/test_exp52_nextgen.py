...
def test_shrunk_delay_calibration_is_finite_and_shrinks():
    rows=pd.DataFrame({"prediction":[0,1,2,3,4,5]*10,"residual":[20]*30+[-20]*30,"sample_weight":[.1]*60,"lifecycle_stage":["early"]*30+["late"]*30})
